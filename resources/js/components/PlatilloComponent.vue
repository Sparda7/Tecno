                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input
                                        ...
                                        class="form-control"
                                        required
                                        placeholder="Ingrese la racion de Grasas..."
                                    />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label
                                    class="col-md-3 form-control-label"
                                    for="number-input"
                                    >Ref/Carbohidrato</label
                                >
                                <div class="col-md-9">
                                    <input
                                        type="number"
                                        v-model="carbohidrato"
                                        class="form-control"
                                        required
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input
                                        ...
                                        class="form-control"
                                        required
                                        placeholder="Ingrese la racion de Proteina..."
                                    />
                                </div>
                            </div>
        ...
        registrar() {
            ...
            axios
                .post(this.url_ctrl + "/registrar", {
                    ...
                    grasa: this.grasa,
                    carbohidrato: this.carbohidrato,
     ...
     eliminar(id)
    {
      ...
      .then(resp => {
        ...
        abrirModal(accion, data = []) {
            switch (accion) {
                ...
                case "actualizar": {
                    ...
                    this.racion = data.racion;
                    this.caloria = data.caloria;
                    this.grasa = data.grasa;
                    this.carbohidrato = data.carbohidrato;
                    this.proteina = data.proteina;
                    break;
                }
            }
        },
        ...
        validar() {
            ...
            if (!this.racion) {
                this.mensaje = "Ingrese racion";
                return true;
            }
            if (!this.grasa) {
                this.mensaje = "Ingrese Grasa";
                return true;
            }
            return false;
        }
