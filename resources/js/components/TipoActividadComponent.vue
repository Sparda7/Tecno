...
export default {
    ...
    methods: {
        ...
        selectTipo(search, loading) {
            loading(true);
            var url = "actividadfisica/select?buscar=" + search;
            axios
                .get(url)
                .then(resp => {
        ...
        getDatoTipo(val1) {
            this.idactividadfisica = val1.id;
            this.actividadfisica = val1.nombre;
            this.vue_tipo = {
                id: val1.id,
                nombre: val1.nombre
            };
        ...
        abrirModal(accion, data = []) {
            switch (accion) {
                ...
                case "actualizar": {
                    ...
                    this.idactividadfisica = data.idactividadfisica;
                    this.tipoactividad = data.tipoactividad;
                    this.vue_tipo = {
                        id: this.id,
                        nombre: this.actividadfisica
                    };
                    break;
                }
            }
        ...
        validar() {
            if (!this.tipoactividad) {
                this.tipoactividad = "Ingrese el Nombre";
                return true;
            }
            if (!this.idactividadfisica) {
