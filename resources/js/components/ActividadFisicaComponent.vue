            ...
            <table class="table table-bordered table-striped table-sm">
              ...
              <tbody>
                <tr v-for="data in array_data" :key="data.id">
                  <td>
                    <span class="badge badge-success">{{ data.id }}</span>
                  </td>
                  <!-- crea  lista para los atributos de la tabla -->                  
                  <td>{{ data.nombre }}</td>
...
export default {
  ...
  methods: {
    ...
    validar() {
      if (!this.nombre) {
        this.mensaje = "Ingrese el nombre porfa";
        return true;
      }
      if (!this.calorias) {
        this.mensaje = "Ingrese Calorias!! ";
        return true;
      }
      return false;
    }
